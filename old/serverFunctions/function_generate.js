import { fileIOread, fileIOwrite, fileIOdelete, makeFolder, storeObject, readObject } from "../fileIO.js";
...
export async function testTheCode(inputObject) {
    ...
    const codeToTest = inputObject.code_js;
